...
<div id="cms-blog-links" class="rounded-lg border-2 border-teal-400/50 bg-teal-500/10 p-4 space-y-4">
    <div>
        ...
        <p class="cms-help text-teal-100/80 mt-1">Controla os botões do Blog na home (hero, ponte, funil). Marque <strong>Links ativos</strong> quando a URL pública estiver pronta.</p>
    </div>
    ...
    <label class="flex items-center gap-2 text-sm rounded-lg border border-white/15 px-3 py-2.5 bg-black/25 font-medium text-white">
        ...
        Links do Blog ativos
    </label>

    <div class="grid gap-4 lg:grid-cols-2">
        <div class="rounded-lg border border-white/10 bg-black/20 p-3 space-y-2">
            <p class="text-xs font-bold uppercase tracking-wide text-amber-200">Botão principal — conhecer / conteúdo</p>
        ...
        <div class="rounded-lg border border-white/10 bg-black/20 p-3 space-y-2">
            ...
            <input class="cms-input" name="blog_cta_pending" value="{{ $blog['cta_pending'] ?? 'Conteúdo e tutoriais no Blog' }}">
        ...
        <div class="rounded-lg border border-white/10 bg-black/20 p-3 space-y-2">
            <p class="text-xs font-bold uppercase tracking-wide text-violet-200">Botão cadastro / ler no Blog</p>
            <p class="cms-help mb-0">Ponte e funil (só quando links ativos)</p>
            <label class="cms-label">Texto do botão</label>
            <input class="cms-input" name="blog_register_cta" value="{{ $blog['register_cta'] ?? 'Ler no Blog' }}">
