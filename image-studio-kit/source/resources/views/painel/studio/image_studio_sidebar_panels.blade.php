...
<div class="rounded-xl border border-violet-900/40 bg-violet-950/20 p-3 space-y-2">
    ...
    <button type="button" @click="imageStudioSaveToBlog()" class="w-full text-xs py-2 rounded-lg bg-emerald-800 hover:bg-emerald-700">
        Baixar PNG e salvar no blog
    </button>
    <button type="button" @click="imageStudioClearWorkspace()" class="w-full text-xs py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 border border-zinc-700">
        ⌫ Limpar área
    </button>
    <p class="text-[9px] text-zinc-500">Rascunho fica só neste navegador. “Salvar no blog” grava PNG em storage para usar nos artigos.</p>
</div>
