# Acessos MarkCraft — cópia local (NÃO versionar)

Copie para `docs/ACESSOS-LOCAL.md` (ignorado pelo Git). Preencha com seus dados.

## Site produção

- **URL:** https://markcraft.criasysweb.com.br/
...
- **REMBG_PYTHON:** `/home/USUARIO/miniconda3/bin/python`

## CriaSys

- **Blog:** https://blog.criasysweb.com.br/
- **Site:** https://criasysweb.com.br/
